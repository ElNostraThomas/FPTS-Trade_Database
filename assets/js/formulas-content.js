...
window.FormulasContent = {
  ...
  sessions: [
    ...
    { id: 's36', public: true,        date: '2026-06-29', dateLabel: 'Jun 29, 2026', tag: 'S36',  title: 'Rookies labeled "via rookie draft"', blurb: 'Incoming rookies (no NFL snaps yet) used to be hidden from the Waiver Wire "Most Valuable Available" board and each league\'s Best Available list, since you can\'t waiver-claim them. Now they\'re shown but clearly tagged "via rookie draft" — so a valuable incoming rookie still appears where you\'d expect, with a one-glance reminder that he comes through your rookie draft rather than the waiver wire. The tag clears itself automatically once he plays his first down.' },
    { id: 's35', public: true,        date: '2026-06-29', dateLabel: 'Jun 29, 2026', tag: 'S35',  title: 'Smarter Trade Builder suggestions', blurb: 'The one-at-a-time Trade Builder you open from a player or pick now proposes packages through the exact same quality engine as the sidebar Trade Finder — instead of raw value matches. Offers are built near-even (Fair mode), drop "rookie flier + a pick for my real player" lowballs, weight the players you send by whether they\'d actually start for the other team, tell you whether the owner is deep at that position (likely to sell) or thin, and flag any offer that would weaken your own starting lineup. The target is also now valued in that league\'s exact format (Superflex / 1QB / TEP) so the math lines up with your roster.' },
    { id: 's34', public: true,        date: '2026-06-16', dateLabel: 'Jun 16, 2026', tag: 'S34',  title: 'Pick a league inside the Trade Calculator', blurb: 'The Roster Moves Trade Calculator now has a League picker right in the modal — choose one of your leagues and "You Send" fills with your roster and everything is valued in that league\'s format (Superflex or 1QB). Optionally pick the manager you\'re trading with and "You Receive" narrows to just their roster; leave it on "Anyone" to freely search any player or pick (still valued for that league). Leave the picker on "Free calculator" for the open, league-agnostic calculator. No need to open My Leagues first.' },
    { id: 's33', public: true,        date: '2026-06-16', dateLabel: 'Jun 16, 2026', tag: 'S33',  title: 'ADP Trend — By Week', blurb: 'The player-card ADP Trend tab gained a By Week view alongside By Month and By Year, so you can watch a player\'s startup draft slot move week to week through the current season — handy for catching a riser or faller before the monthly average reflects it. Each point is that week\'s average startup pick (lower = drafted earlier). It\'s Superflex-only for now (nearly every dynasty startup is SF, so the 1QB weekly sample is too thin to be meaningful) and covers roughly the top ~300 players.' },
    { id: 's32', public: true,        date: '2026-06-15', dateLabel: 'Jun 15, 2026', tag: 'S32',  title: 'ADP Trend tab on player cards', blurb: 'Open any player and the card now has an ADP Trend tab — a line chart of where he\'s been getting drafted over time (average startup draft slot, lower = earlier). Toggle By Month (across the current season) or By Year (across seasons), and SF or 1QB, with a Peak / Lowest / Avg / Current readout below the chart. Available everywhere a player card opens — the Database, ADP Tool, My Leagues, Tiers and Rankings.' },
