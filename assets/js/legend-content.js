  ...
  'mock-draft': {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { label: 'ADP Value', what: 'Strict to ADP. Won\'t reach more than ~3 picks past consensus. Picks land close to where the player\'s ADP says they should go.', source: 'PERSONALITIES.adp_value in mock-draft.html', values: 'weights: adp 0.65 / posNeed 0.20 / value 0.15 / scarcity 0.10. reachTolerance: 3 picks. Candidate window: [pick-36, pick+12].', notes: 'The "calmest" opponent — useful as a baseline when you want predictable behavior. ADP weight bumped 0.55 → 0.65 in 2026-05-20 first tweak.' },
          { label: 'Best Player Available', what: 'Picks the highest-trade-value player regardless of roster need. Will draft a 3rd RB in round 4 if that\'s the best value.', source: 'PERSONALITIES.bpa', values: 'weights: adp 0.40 / posNeed 0.05 / value 0.50 / scarcity 0.15. reachTolerance: 8. Window: [pick-48, pick+24].', notes: 'value weight dominates; posNeed is nearly zero so this seat ignores roster construction. ADP weight bumped 0.30 → 0.40 in 2026-05-20 first tweak.' },
          { label: 'My Guys', what: 'Has 8 "favorite players" seeded from the top 80 FP_VALUES at draft start. Reaches hard for them when they\'re close to available. Mostly ignores ADP.', source: 'PERSONALITIES.my_guys + seedFavorites()', values: 'weights: adp 0.18 / posNeed 0.25 / value 0.30 / scarcity 0.10 / favor 0.25. reachTolerance: 18. Window: [pick-60, pick+36].', notes: 'favorScore = +1.5 when the candidate is on the opponent\'s favorites list. Favorites are random per opponent per draft, so two My Guys seats won\'t target the same players. ADP weight bumped 0.10 → 0.18 in 2026-05-20 first tweak.' },
          { label: 'Need-Based', what: 'Fills roster holes aggressively. Targets QB early in SF leagues, balances RB+WR, picks TE in middle rounds. Avoids overdrafting any one position.', source: 'PERSONALITIES.need_based', values: 'weights: adp 0.30 / posNeed 0.55 / value 0.15 / scarcity 0.10. reachTolerance: 6. Window: [pick-42, pick+18].', notes: 'posNeed dominates; once a position\'s target is met, that position\'s score goes negative. ADP weight bumped 0.20 → 0.30 in 2026-05-20 first tweak.' },
          { label: 'Positional Scarcity', what: 'Attacks tier cliffs. Reaches when a tier of QBs / TEs / RBs is about to break and only 1-2 players remain in it.', source: 'PERSONALITIES.scarcity + computeTierScarcity()', values: 'weights: adp 0.35 / posNeed 0.15 / value 0.20 / scarcity 0.40. reachTolerance: 12. Window: [pick-48, pick+24].', notes: 'scarcityScore = 1.0 if <=2 players left in player\'s tier at that position, 0.5 if <=4 left, 0 otherwise. Tier from FP_VALUES.tier. ADP weight bumped 0.25 → 0.35 in 2026-05-20 first tweak.' },
        ],
      },
      {
